...
Makefile: outputdir configure $(INSTALL_PREFIX)/db-$(DB4_VERSION).NC.tar.gz $(INSTALL_PREFIX)/$(PLOG_VERSION).tar.gz $(INSTALL_PREFIX)/v$(VDF_VERSION).tar.gz $(INSTALL_PREFIX)/$(BLS_SIGNATURES_VERSION).tar.gz $(INSTALL_PREFIX)/$(BLAKE3_VERSION).tar.gz
