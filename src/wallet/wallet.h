...
enum WalletFeature
{
    ...
    FEATURE_DePINC_BASE = FEATURE_NO_DEFAULT_KEY, // BitcoionHD base feature

    FEATURE_LATEST = FEATURE_DePINC_BASE
};
...
public:
    ...
    bool SubmitMemoryPoolAndRelay(std::string& err_string, bool relay, interfaces::Chain::Lock& locked_chain, bool ignore_max_fee_check = false);
